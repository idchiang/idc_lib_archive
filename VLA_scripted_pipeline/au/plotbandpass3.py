...
PLOTBANDPASS_REVISION_STRING = "$Id: plotbandpass3.py,v 1.198 2018/04/04 15:20:48 thunter Exp $" 
import pylab as pb
...
def version(showfile=True):
    ...
    """
    myversion = "$Id: plotbandpass3.py,v 1.198 2018/04/04 15:20:48 thunter Exp $" 
    if (showfile):
