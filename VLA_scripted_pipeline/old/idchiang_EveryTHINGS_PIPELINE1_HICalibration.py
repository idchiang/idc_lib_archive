...
if just_for_debug:
    ...
    ms_active, tb, uvcontsub, ms, gencal, default = 0
...
print("#")
"""
print("...Tar the calibrated ms")
with tarfile.open(ms_active + '.tar.gz', 'w:gz') as tar:
    tar.add(ms_active, arcname=os.path.basename(ms_active))
print("#")
print("...Removing the calibrated ms")
rmtree(ms_active)
print("#")
"""
print('# Start time: ' +
